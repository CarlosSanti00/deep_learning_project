...
while epoch < num_epochs:
    ...
    if epoch % 5 == 0:
        ...
        ax.legend()
        fig.savefig('elbo_plot_LN_wRELU_VAE_final.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('elbo_plot_LN_wRELU_baseline_final.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('kl_plot_LN_wRELU_VAE_final.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('kl_plot_LN_wRELU_baseline_final.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('nll_plot_LN_wRELU_VAE_final.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('nll_plot_LN_wRELU_baseline_final.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('loss_plot_LN(final)_CSL.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('loss_plot_LN_wRELU_baseline_final.png')
        plt.close(fig)
...
fig.savefig('loss_plot_LN_wRELU_VAE_final.png')
plt.close(fig)
