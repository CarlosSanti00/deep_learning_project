...
while epoch < num_epochs:
    ...
    with torch.no_grad():
        ...
        with open('../Log_out_files/original_and_reconstructed_LN(newRELU)_CSL.txt', 'a') as file:
    ...
    if epoch % 5 == 0:
        ...
        ax.legend()
        fig.savefig('../plots/elbo_plot_LN(newRELU)_CSL.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('../plots/kl_plot_LN(newRELU)_CSL.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('../plots/nll_plot_LN(newRELU)_CSL.png')
        plt.close(fig)
        ...
        ax.legend()
        fig.savefig('../plots/loss_plot_LN(newRELU)_CSL.png')
        plt.close(fig)
...
vae_path = "../VAE_settings/vae_settings_LN(newRELU)_CSL.pth"
encoder_path = "../VAE_settings/encoder_LN(newRELU)_CSL.pth"
decoder_path = "../VAE_settings/decoder_LN(newRELU)_CSL.pth"
